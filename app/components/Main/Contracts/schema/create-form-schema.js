...
export const createContractSchema = (lang) => {
    return z.object({
        clientPhone: z.string().min(8, { message: lang === 'ar' ? 'رقم الهاتف مطلوب' : 'Phone number is required' }),
        ...
        installments: z.array(z.object({
            date: z.string({ required_error: lang === 'ar' ? 'تاريخ القسط مطلوب' : 'Installment date is required' }),
